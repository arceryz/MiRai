...
int main()
{
    ...
    int lineBuf = rlLoadShaderBuffer(polygon.segments.size()*sizeof(LineSegment), polygon.segments.data(),
        RL_DYNAMIC_READ);
    ...
    while(!WindowShouldClose()) {
        ...
        { // Render Pass.
            ...
            rlEnableVertexArray(pointVao);
            rlDrawVertexArrayInstanced(0, 3, WORKGROUP_SIZE*numWorkgroups);
            rlDisableVertexArray(); 
            rlDisableShader();
